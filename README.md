...
- [x] Created an **AD forest**, **Domain**, and activated **AD Domain Services** and **Domain Name System**.
- [x] Configured **Security Groups**, **Users**, and more to achieve a properly simulated enterprise onboarding experience. 
- [x] Connect **Domain Client** to **Domain Controller** and successfully configured file sharing.
